<template>
  <footer>
    <div class="footer box">
      <div class="wx-box">
        <ul>
          <li><img src="../../assets/images/qrcode_qq.png"><span>我的QQ</span></li>
          <li><img src="../../assets/images/qrcode_wx.png"><span>我的微信</span></li>
        </ul>
      </div>
      <div class="end-nav">
        <p><b>站点声明：</b></p>
        <p>1、本站仅为个人测试开发，均为Roy本人设计，个人可以使用，但是未经许可不得用于任何商业目的。</p>
        <p>
